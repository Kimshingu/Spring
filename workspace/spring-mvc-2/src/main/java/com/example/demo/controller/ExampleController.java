...
//			produces = {"text/plain" }, // 결과의 MIME 타입
	...
	//클라이언트의 지역정보가 담겨 있다.
	@GetMapping("/example2")
	public String example2( HttpServletRequest req, Model model, 
	...
	public ModelAndView example3(
			...
			User user) {  // 파라미터를 받는 방법 #2, 사용조건: 파라미터 키값과 멤버변수명이 같아야 한다.
...
/*		http://localholst:8080/mvc/seoule/sales/team1
		seoul/sales/team1
		"/" 문자열을 잘라서 배열로 전환*/
